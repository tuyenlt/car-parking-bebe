...
export class Migrations1763963956933 implements MigrationInterface {
    name = 'Migrations1763963956933'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "temporary_bill" ("id" varchar PRIMARY KEY NOT NULL, "created_at" datetime DEFAULT (datetime('now')), "updated_at" datetime DEFAULT (datetime('now')), "deleted_at" datetime, "bill_code" varchar(255) NOT NULL, "bill_time" datetime NOT NULL, "amount" decimal(10,2) NOT NULL, "payment_method" varchar(255) NOT NULL, "description" varchar(255), "is_paid" boolean NOT NULL DEFAULT (0), "qr_code" varchar(255), "carHistoryId" varchar NOT NULL, "vnp_url" varchar(255), CONSTRAINT "UQ_8bc949af4d0949696ad4538d833" UNIQUE ("carHistoryId"), CONSTRAINT "UQ_65e080814ef684970ae977cf1b1" UNIQUE ("bill_code"), CONSTRAINT "FK_81009097ebabd6ea09e14ed165c" FOREIGN KEY ("carHistoryId") REFERENCES "car-history" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION)`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "bill" ("id" varchar PRIMARY KEY NOT NULL, "created_at" datetime DEFAULT (datetime('now')), "updated_at" datetime DEFAULT (datetime('now')), "deleted_at" datetime, "bill_code" varchar(255) NOT NULL, "bill_time" datetime NOT NULL, "amount" decimal(10,2) NOT NULL, "payment_method" varchar(255) NOT NULL, "description" varchar(255), "is_paid" boolean NOT NULL DEFAULT (0), "qr_code" varchar(255), "carHistoryId" varchar NOT NULL, CONSTRAINT "UQ_8bc949af4d0949696ad4538d833" UNIQUE ("carHistoryId"), CONSTRAINT "UQ_65e080814ef684970ae977cf1b1" UNIQUE ("bill_code"), CONSTRAINT "FK_81009097ebabd6ea09e14ed165c" FOREIGN KEY ("carHistoryId") REFERENCES "car-history" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION)`);
